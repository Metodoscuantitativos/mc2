...
| Actividad evaluativa | Breve descripción | Modalidad | Fecha | Ponderación |
|----------------------|-------------------|-----------|-------|-------------|
| Evaluación Individual 2 | Prueba presencial individual manipulación de bases y estadística descriptiva | Individual | 14-06 | 25% |
...
- Ojalá conservar los grupos. Si alguien quiere cambiar, converselo con sus sus compañeros. Diganme la próxima clase. 
- ¿Qué se hará?: 
...
- **Próxima clase**: re-leer cuestionarios de otros grupos y plantear críticas constructivas a los cuestionarios
...
# Próxima clase
- Cada grupo deberá enviar los formularios gforms a otrxs compañeros
- Cada grupo deberá entregar sugerencias a compañerxs respecto a las preguntas del cuestionario.
  + ¿Qué preguntas se entienden? y ¿cuáles no?
  + ¿Qué alternativas se entienden? y ¿cuáles no?
