...
#recuerden que dicha base es un fragmento de la Encuesta de Monitoreo de Indicadores Sociales del Proyecto Hidroeléctrico Alto Maipo (PHAM) 

base_pham <- read_excel(file = "fuente/Alto Maipo.")
