### PRUEBA RECUPERATIVA 1 ###

#                                       ***********Instrucciones************

# a. Ir a File y crear un Rproject denominelo: apellido_prueba1.Rproj, por ejemplo: "Ocampo_prueba1.Rproj"
# b. Guardar este script (prueba_recuperativa.R) y base de datos de Alto Maipo (ALTO MAIPO.XLSX) en la carpeta Rproject
# c. Comenzar y desarrollar la prueba en este script
# d. Al finalizar debe guardar este script en la carpeta del proyecto denominada apellido_recuperativa1.Rproj, 
# comprimir la carpeta del proyecto y enviarla a ginowrs@gmail.com y semunoz@uahurtado.cl Con el asunto
# apellido prueba recuperativa 1

#parte 0: Muestreo. Debe elegir 2 de las 3 preguntas y responderlas en este script

# 1. Explique las diferencias entre muestreo probabilístico y no probabilístico. Proporcione ejemplos de cada tipo y mencione una ventaja y una desventaja de cada uno.
# 2. Defina el término "tamaño de muestra". ¿Cómo se determina el tamaño adecuado de una muestra en una investigación? Mencione al menos tres factores que influyen en la determinación del tamaño de muestra.
# 3. ¿Qué es el muestreo sistemático y en qué situaciones puede ser preferible al muestreo aleatorio simple? Proporcione un ejemplo de cómo se realiza un muestreo sistemático.


# Parte 1: R base ---------------------------------------------------------

#0.1 Crear un VECTOR llamado Estatura que contenga la estatura en centímetros de los/as miembros/as de su familia. (1 pto)
...
#0.2 Crear 3 vectores (NOMBRE, equipo_futbol, tipo_ocupacion) (3 ptos)
# con la misma cantidad de elementos que Estatura, pero con variables de tipo character (texto).
#  tipo_ocupacion: asigne los valores: "empleador", "trabajador por cuenta propia", "trabajadore dependiente", "jubilado", "ambulante", etc.

#0.3 Modificar el tercer elemento de tipo_ocupacion, asignandole el valor "FFAA y de orden" (1 pto)
...
# 01.1 Elimine la segunda fila de la base de datos


# 01.2 Indique la cantidad de observaciones y de variables utilizando las funciones 
# correspondientes (sòlo se aceptan respuestas con código).
...
#03. Supongan que sólo les interesa trabajar con las variables sistema_salud, localidad y lugar_traslado
...
# 04. Tome esa misma base (ALTO MAIPO) y con el método de acceso de corchetes [] conserve  los últimos 200 casos/filas
...
#02. Usando la función select() seleccione las variables sistema_salud, localidad y lugar_traslado con:
...
# Guarde su base recodificada con sólo 200 casos y tres variables (sistema_salud, localidad y lugar_traslado) en la carpeta del proyecto con la siguiente función 
