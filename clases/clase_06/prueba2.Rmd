...
* Pueden distinguirse al considerar
  ...
  + *Cantidad de variables*: univariado, bivariados, multivariados
  
  + *Tipo de variables*: si utilizan variables categóricas, cuantitativas o ambas. 
...
- Es importante identificar la variable independiente y la variable dependiente para poder interpretar correctamente los resultados.
